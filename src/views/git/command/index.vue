<template>
    <div class="container">
      ...
      <div class="block">
        ...
        <div class="item">
          <div class="title">合并最近切换分支</div><code class="code">git merge -</code>
        </div>
        <div class="item">
      ...
      <div class="block">
        ...
        <div class="item">
          <div class="title">同步远程仓库已删除分支</div><code class="code">git remote prune origin</code>
        </div>
      </div>
      <div class="block">
        <h3>推送与拉取</h3>
      ...
      <div class="block">
        ...
        <div class="item">
          <div class="title">追加提交重置提交信息</div><code class="code">git commit --amend -m &lt;message&gt;</code>
        </div>
        <div class="item">
      ...
      <div class="block">
        ...
        <div class="item">
          <div class="title">根据提交源码中的关键字查找</div><code class="code">git log -S &lt;keyword&gt;</code>
        </div>
        <div class="item">
